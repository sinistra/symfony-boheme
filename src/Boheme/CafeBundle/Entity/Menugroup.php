<?php
// file: src/Boheme/CafeBundle/Entity/Menugroup.php
...
/**
 * @ORM\Entity(repositoryClass="Boheme\CafeBundle\Entity\MenugroupRepository")
 * @ORM\Table(name="menugroups")
 */
...
class Menugroup {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Meal", mappedBy="menugroup")
     */
    private $meals;
