<?php
// file: src/Boheme/CafeBundle/Entity/Winetype.php
...
/**
 * @ORM\Entity(repositoryClass="Boheme\CafeBundle\Entity\WinetypeRepository")
 * @ORM\Table(name="winetypes")
 */
...
class Winetype {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Wine", mappedBy="type")
     */
    private $wines;
